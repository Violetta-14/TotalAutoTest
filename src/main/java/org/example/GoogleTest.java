...
public class GoogleTest {
    ...
    public ChromeDriver prepare(){
        System.setProperty("webdriver.chrome.driver", "C:\\Users\\Violetta\\Documents\\ChromeDriver\\chromedriver-win64\\chromedriver.exe");
    ...
    public void googleSearchTest(){
        ...
        By searchButton = By.xpath("//div[@class='lJ9FBc']/center/input[@value= 'Поиск в Google']");
