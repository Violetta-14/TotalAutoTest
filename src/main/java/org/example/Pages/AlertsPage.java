...
public class AlertsPage extends BasePage{
    ...
    @Step("Проверить пятница ли сегодня (да - подтвердить, нет - отклонить)")
    ...
    @Step("Нажать на подтверждение алерта")
    ...
    @Step("Нажать на нопку отмены алерта")
    ...
    @Step("Ввести текст в поле ввода алерт")
